...
#pragma region Windows Form Designer generated code
		...
		void rowsadd(String^ s1, String^ s2) {
			this->dataGridView1->Invoke(gcnew Action<String^>(this, &BaseForm::rowsaddDel), s1);
			this->dataGridView1->Rows[this->dataGridView1->RowCount - 2]->Cells[0]->Value = s1;
			this->dataGridView1->Rows[this->dataGridView1->RowCount - 2]->Cells[1]->Value = s2;
		}
...
private: System::Void buttonEnd_Click(System::Object^ sender, System::EventArgs^ e) {
	String^ s = " ";
	endFromNum(msclr::interop::marshal_as<std::string>(s));
}
private: System::Void buttonSend_Click(System::Object^ sender, System::EventArgs^ e) {
	String^ s = " ";
	sendDataFromNum(msclr::interop::marshal_as<std::string>(s), msclr::interop::marshal_as<std::string>(s));
}
private: System::Void buttonGet_Click(System::Object^ sender, System::EventArgs^ e) {
	String^ s = " ";
	getDataFromNum(msclr::interop::marshal_as<std::string> (s), msclr::interop::marshal_as<std::string>(s));
}
private: System::Void dataGridView1_CellClick(System::Object^ sender, System::Windows::Forms::DataGridViewCellEventArgs^ e) 
{
	if (this->dataGridView1->RowCount >= 2)
	{s1 = this->dataGridView1->Rows[this->dataGridView1->RowCount - 2]->Cells[0]->Value->ToString();
	 s2 = this->dataGridView1->Rows[this->dataGridView1->RowCount - 2]->Cells[1]->Value->ToString();}
}
};
}
